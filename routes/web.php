...
Route::group(['middleware' => 'auth'], function() {
    Route::group(['middleware' => 'verified', 'role:user', 'prefix' => 'user', 'as' => 'user.'], function() {
        ...
        Route::get('wallets/{symbol}', 'WalletController@wallet')->name('wallet.info');
        Route::post('wallet/create', 'WalletController@create')->name('wallet.create');
        Route::post('wallet/send', 'WalletController@send')->name('wallet.send');
        Route::post('wallet/request', 'WalletController@request')->name('wallet.request');
        ...
        // Deposit
        Route::any('deposit/wallet/{address}', 'Gateway\PaymentController@deposit')->middleware('checkKYC')->name('deposit');
